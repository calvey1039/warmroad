...
function BookingLinks({ destinationName, destinationState }: { destinationName: string; destinationState: string }) {
  const destinationLabel = `${destinationName}, ${destinationState}`;
  ...
  const lodgingSites = [
    { id: "expedia", name: "Expedia", url: buildExpediaAffiliateUrl({ destination: destinationLabel, bookingType: "lodging", startDate: checkInStr, endDate: checkOutStr }), icon: "\uD83C\uDFE8" },
  ...
  const flightSites = [
    { id: "expedia_flights", name: "Expedia", url: buildExpediaAffiliateUrl({ destination: destinationLabel, bookingType: "flights" }), icon: "\uD83C\uDFE8" },
  ...
  const carSites = [
    { id: "expedia_cars", name: "Expedia", url: buildExpediaAffiliateUrl({ destination: destinationLabel, bookingType: "cars" }), icon: "\uD83C\uDFE8" },
...
interface RouteWeatherToolProps {
  destId: string;
}

export default function RouteWeatherTool({ destId }: RouteWeatherToolProps) {
